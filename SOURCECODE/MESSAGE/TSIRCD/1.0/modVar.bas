...
Public Const Build As String = "tsIRCd 1.0rev8"
...
Select Case args(0)
  ...
  Case "VERSION"
    SM FromSock, ":" + ServerHost + " 351 " + Clients(FromSock).Nick + " 1.0rev8 " + ServerHost + " :Running tsIRCd. Server is experimental and under development."
