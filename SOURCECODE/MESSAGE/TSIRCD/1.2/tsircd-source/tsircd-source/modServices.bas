...
nf = FreeFile
Open WorkDir + "db.nicknames" For Binary As #nf: Close #nf
Open WorkDir + "db.nicknames" For Input As #nf
...
Open WorkDir + "db.channels" For Binary As #nf: Close #nf
Open WorkDir + "db.channels" For Input As #nf
...
nf = FreeFile
Open WorkDir + "db.nicknames" For Output As #nf
For n = 1 To NickDBCount
...
Open WorkDir + "db.channels" For Output As #nf
