...
Public Const Build As String = "tsIRCd 1.2"
...
nf = FreeFile
Open WorkDir + "tsIRCd.config" For Input As nf
For n = 1 To 1000
  Opers(n).Host = ""
  Opers(n).Modes = ""
  Opers(n).Name = ""
...
Select Case args(0)
  ...
  Case "VERSION"
    SM FromSock, ":" + ServerHost + " 351 " + Clients(FromSock).Nick + " 1.2 " + ServerHost + " :Running tsIRCd. Server is experimental and under development."
